...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Dagmawi Tewodros, a software developer based in Addis Ababa building web and mobile applications." },
      { name: "author", content: "Dagmawi Tewodros" },
      { property: "og:title", content: "Dagmawi Tewodros — Software Developer" },
      { property: "og:description", content: "Portfolio of Dagmawi Tewodros, a software developer based in Addis Ababa building web and mobile applications." },
